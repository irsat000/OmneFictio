...
$(document).ready(function () {
    ...
    let library_currentSubTab = "saved";
    ...
    function changeSettingsTab(tab) {
        ...
        switch (tab) {
            case "/settings/library":
                ...
                if (library_currentSubTab === "saved") {
                    createSBody_saved();
                } else {
                    createSBody_liked();
                }
    ...
    function createSBody_saved() {
        document.querySelector('.s-about_you a[data-subtab="saved"]').classList.add('active');
        document.querySelector('.s-about_you a[data-subtab="liked"]').classList.remove('active');
        library_currentSubTab = "saved";
        //alert("favs");
    }
    function createSBody_liked() {
        document.querySelector('.s-about_you a[data-subtab="liked"]').classList.add('active');
        document.querySelector('.s-about_you a[data-subtab="saved"]').classList.remove('active');
